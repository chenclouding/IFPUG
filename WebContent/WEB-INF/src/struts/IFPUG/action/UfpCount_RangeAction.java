 ...
 * 
 * XDoclet definition:
 * @struts.action path="/ufpCount_Range" name="ufpCountOfEpForm" scope="request" validate="true"
 * @struts.action-forward name="success" path="/IFPUG/transaction/rangeMethod.jsp" contextRelative="true"
 * @struts.action-forward name="failure" path="/IFPUG/failure.jsp" contextRelative="true"
 */
public class UfpCount_RangeAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		Short ftrRange, detRange;
		int complex, ufpCount;
		ftrRange = Short.valueOf(ufpCountOfEpForm.getFtrRange());
		detRange = Short.valueOf(ufpCountOfEpForm.getDetRange());
		UfpCountBusiness ucb = new UfpCountBusiness(); //调用计算功能的业务逻辑层
		complex = ucb.getComplex_RangeMethod(detRange, ftrRange, type+2);//调用业务逻辑层函数，计复杂度
		...
		case 0:
			...
			eiMethod.setDetRange(detRange);
			eiMethod.setFtrRange(ftrRange);
			eiMethod.setMethodType(Short.valueOf("2"));
		...
		case 1:
			...
			eoMethod.setDetRange(detRange);
			eoMethod.setRetRange(ftrRange);
			eoMethod.setMethodType(Short.valueOf("2"));
		...
		case 2:
			...
			eqMethod.setDetRange(detRange);
			eqMethod.setFtrRange(ftrRange);
			eqMethod.setMethodType(Short.valueOf("2"));
