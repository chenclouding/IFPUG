...
<html>
  ...
  <%
   ...
   <table borderColor="#65AB83" cellSpacing="0" cellPadding="0"  align=center border =1>
    ...
    <tr>
    	<td valign="top" width="20%">功能名称：</td><td valign="top"><%=fp.getFunctionName() %></td>
    </tr>
    <tr>
    	<td valign="top" width="20%">功能描述：</td>
    ...
    <tr>
  	...
  	<a href="Javascript:window.parent.location='/ifpug/IFPUG/requirement/functionList.jsp?productId=<%=productId%>'"><span>返 回</span></a>
  </body>
</html>
