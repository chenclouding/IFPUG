...
<html>
  ...
  <form  action ="/ifpug/IFPUG/editElementaryProcess.do" name ="epForm">
  		...
  		<tr>
  	    	...
  	    	<td  valign="top">
                  ...
                  for (var i = 0; i < 3; i ++){//变量epType是基本流程的类型，取值为0、1、2 
                  	if (i == <%=epType%>) type[<%=epType%>].checked = true; //通过epType值，选中对应按钮
    ...
    <input type='button' onclick="Javascript:window.location='elementaryProcessList.jsp?functionId=<%=functionId%>'" value=" 返 回 ">
