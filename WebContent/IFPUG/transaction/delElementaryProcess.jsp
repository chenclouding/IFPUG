  ...
  <body>
    <%
      ...
      //Integer functionId = function.getId();
       //删除该数据组对应的数据属性
      boolean result = rb.delElementaryProcessById(type,epId);
      if(result==true){
      	//response.sendRedirect("/ifpug/IFPUG/transaction/addMethodToEp.jsp?functionId="+functionId+"&&epType="+epType);
      }
  %>
  </body>
</html>
