...
<!--Something Here-->
            ...
            <table width="215" border="0" cellspacing="0" cellpadding="0" height="40" background="/ifpug/images/index_lm.gif">
              <tr>
                <td> <div align="center"><b><a href="/ifpug/index.jsp">主页</a></b> </div></td>
              </tr>
            </table>
...
<!--Page.Content.Begin-->
<!--Something Here-->
<form name="form1" id="_form" method="post" onSubmit="return check()" action="admin.jsp"  >
  <table width="60%"  border="0" align="center" cellpadding="1" cellspacing="1">
   <tr>
    ...
    <tr>
      ...
      <td width="50%">管理员用户名</td>
      <td><input id="username" type="text" name="username" ></td>
    </tr>
    <tr>
      <td width="50%">管理员密码  </td>
    ...
    <tr>
      ...
      <td><div align="center">
         <input width="50%" type="button" value="登 录" onClick="check()">
      </div></td>
    </tr>
  </table>
  <p>&nbsp;</p>
