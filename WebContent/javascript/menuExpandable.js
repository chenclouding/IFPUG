...
function initializeMenu(menuId, actuatorId) {
    ...
    actuator.parentNode.style.backgroundImage = "url(/gcgl/images/plus.gif)";
    actuator.onclick = function() {
        var display = menu.style.display;
        this.parentNode.style.backgroundImage =
            (display == "block") ? "url(/gcgl/images/plus.gif)" : "url(/gcgl/images/minus.gif)";
...
function openMenu(menuId) {
    ...
    if (menu != null) {
        var display = menu.style.display;
        menu.parentNode.style.backgroundImage = "url(/gcgl/images/minus.gif)";
        menu.style.display = (display == "block") ? "none" : "block";
    }
}
