...
public class RequirementBusiness {
	...
	public Date formatStrToDate(String dateStr)
	{
		...
		if((splitStr[1].charAt(0)!='0')&&Integer.valueOf(splitStr[1]) < 10) splitStr[1]="0"+splitStr[1];
		if((splitStr[2].charAt(0)!='0')&&Integer.valueOf(splitStr[2]) < 10) splitStr[2]="0"+splitStr[2];
